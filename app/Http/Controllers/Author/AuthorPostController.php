...
class AuthorPostController extends Controller
{
    public function index()
    {
        ...
        return view('author.news.posts', compact('posts'));
    }

    public function create()
    {
        $sub_categories = SubCategory::with('rCategory')->get();
        return view('author.news.post-create', compact('sub_categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('author-posts')->with('success', 'Post is added successfully');
    }

    public function edit($id)
    {
        $edit_authorization = Post::where('id', $id)->where('author_id', Auth::guard('author')->user()->id)->count();
        ...
        return view('author.news.post-edit', compact('post', 'sub_categories', 'tags_data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('author-posts')->with('success', 'Post is updated successfully');
    }
    ...
    public function tag_delete($id, $post_id)
    {
        ...
        return redirect()->route('author-post-edit', $post_id)->with('success', 'Tag is deleted successfully');
    }
