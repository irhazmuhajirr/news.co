...
@section('title', 'Pages - Login')
@section('heading', 'Login Settings')

@section('main_content')
<div class="section-body">
    <form action="{{ route('admin-page-login-update') }}" method="post">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            <label>Status</label>
                            <select name="login_status" class="form-control" id="">
