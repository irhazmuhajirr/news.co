...
@section('title', 'News.com - Frequently Asked Questions')
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    @php $i++; @endphp
                        <div class="accordion-item">
                            ...
                            <div id="collapse{{ $i }}" class="accordion-collapse collapse @if($loop->iteration == 1) show @endif" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
